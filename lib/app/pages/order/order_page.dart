import 'package:app_delivery/app/core/extensions/formater_extensions.dart';
...
import 'package:app_delivery/app/pages/order/order_state.dart';
import 'package:app_delivery/app/pages/order/widget/order_field.dart';
import 'package:app_delivery/app/pages/order/widget/order_product_tile.dart';
import 'package:app_delivery/app/pages/order/widget/payment_types_field.dart';
    ...
    return BlocListener<OrderController, OrderState>(
      listener: (context, state) {
        state.status.matchAny(
          ...
          emptyBag: () {
            showInfo(
                'Sua sacola está vazia, por favor selecione um produto para finalizar o pedido!');
            Navigator.pop(
              context,
              <OrderProductDto>[],
            );
